...
class BuildServer {
    constructor() {
        ...
        this.Router = class Router {
            constructor(options) {
                this._pushGlobalMiddleWares = function(routers, globalMiddleWares) {
                    routers.forEach(obj => {
            ...
            useRouter(RouterClass) {
                ...
                self.classesRoutes[this.base] = this;
                if(Array.isArray(newClass.globalMiddleWares) && newClass.globalMiddleWares.length > 0) {
                    this._pushGlobalMiddleWares(newClass.getRouters, newClass.globalMiddleWares);
                    this._pushGlobalMiddleWares(newClass.postRouters, newClass.globalMiddleWares);
                    this._pushGlobalMiddleWares(newClass.putRouters, newClass.globalMiddleWares);
                    this._pushGlobalMiddleWares(newClass.patchRouters, newClass.globalMiddleWares);
                    this._pushGlobalMiddleWares(newClass.deleteRouters, newClass.globalMiddleWares);
                }
            ...
            function chooseHandlers() {
                ...
                if (matchedReq) {
                    ...
                    if (matchedClass) {
                        ...
                        let allMiddleWares = [...self.middleWares, ...matchedClass.globalMiddleWares];
