...
class BuildServer {
    constructor() {
        ...
        this.Router = class Router {
            constructor(options) {
                ...
                // output warrning
                if(helpers.warnings.router.called == false) {
                    console.warn(helpers.warnings.router.text);
                    helpers.warnings.router.called = true;
                }
            }
            build() {
                this.id = Math.random()
                ...
                this.errorPage = this.errorPage || self.errorPage;
                this.staticFolder =  this.options.staticFolder || this.staticFolder || self.staticFolder;
                this.bindStaticFolder = this.options.bindStaticFolder || this.bindStaticFolder || self.bindStaticFolder;
    ...
    setConfig(options) {
        ...
        this.bindStaticFolder = serverOptions.bindStaticFolder;
