...
class Router {
    ...
    // parseUseMiddleWares() {
    //   console.log(this.useMiddleWares, this.base)
    //   this.useMiddleWares.map(obj => {
    //     this.globalMiddleWares = this.globalMiddleWares || [];
    //     obj.path = `${this.base}/${obj.path}`.replace(/(https?:\/\/)|(\/)+/g, "$1$2");
    //     const pattern = new RouteParser(obj.path);
    ...
    //       })
    //     }
    //     applyMiddleWares(obj.middleWares);
    //   })
    // }
