...
class Router {
    ...
    addRoute(route) {
        ...
        switch (method) {
            case "get":
                this.getRouters.push(new Route_1.default(setOptions, this.base));
            case "post":
                this.postRouters.push(new Route_1.default(setOptions, this.base));
            case "put":
                this.putRouters.push(new Route_1.default(setOptions, this.base));
            case "patch":
                this.patchRouters.push(new Route_1.default(setOptions, this.base));
            case "delete":
                this.deleteRouters.push(new Route_1.default(setOptions, this.base));
        }
        return this;
    }
    setBase() {
