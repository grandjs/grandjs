                    ...
                    if (matchedClass) {
                        if (matchedClass.globalMiddleWares) {
                            if (matchedClass.globalMiddleWares.length > 0) {
                                ...
                                matchedClass.globalMiddleWares[0](req, res, next);
